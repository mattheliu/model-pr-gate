...
想法来源：[@arkuy99](https://x.com/arkuy99) 的
...
保留这份复刻 prompt 的中英文版本，并从 README 链接。在中英文 README 中保留想法来源：
@arkuy99（https://x.com/arkuy99），原帖：https://x.com/arkuy99/status/2096425638018306166?s=20。
使用 MIT 许可；复用已有开源代码时保留相应许可与署名。
示例只用通用 OWNER/REPO 和合成数据。
